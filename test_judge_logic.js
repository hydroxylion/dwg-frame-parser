...
// 误差 10mm 内：842≈841 (A0+3/4 短边)，2084≈2080 (A0+3/4 长边)，缩放≈1.002
// 比例偏差仅 0.07%（< 0.2% 等比缩放容差）→ 识别为 A0+3/4 标准
// 注：曾用 846×2100（比例偏差 0.36% > 0.2%）验证——新容差下不再归 A0+3/4，
//     会落入 A2+3/4 的巧合缩放，故改用真·近似缩放样本保持用例语义
check('842x2084 近似 A0+3/4(比例偏差0.07%)', 842, 2084, 'standard', 'A0+3/4');
